    ...
    <section id="skills" className="relative py-20 px-4 overflow-hidden">
      <div className="container mx-auto">
        <Reveal className="mb-16 text-center">
          <h2 className="text-5xl font-bold mb-4 text-slate-100">💡 Skills</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {skillCategories.map((skillGroup, idx) => (
            <Reveal
              ...
              delay={idx * 150}
            >
              <div className={`bg-slate-800/40 border border-${skillGroup.color}-500/20 rounded-2xl p-8 shadow-sm lift-hover h-full`}>
